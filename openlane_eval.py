...
def eval_openlane_cases():
    cases = ["night_case", 'up_down_case','curve_case','extreme_weather_case','intersection_case','merge_split_case']
    for case in cases:
...
def eval_openlane_validation():
    result_dir = os.path.abspath(os.path.join('data_splits', 'openlane', 'PersFormer_validation'))
    result_2d_dir = os.path.join(result_dir, 'result_2d', 'validation')
    result_3d_dir = os.path.join(result_dir, 'result_3d', 'validation')
